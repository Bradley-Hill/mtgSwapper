...
import { listCards, addFromScryfall, deleteCard, updateCard, bulkImport } from '@/api/cards';
import type { AddFromScryfallPayload, UpdateCardPayload, BulkImportPayload } from '@/types';
...
// --------------------------------------------------------------------------
// useBulkImport — imports a plain-text decklist
// Invalidates the collection cache on success so the new cards appear immediately.
